...
Q_CONSTINIT static const qt_meta_stringdata_CLASSThreadToReplaceENDCLASS_t qt_meta_stringdata_CLASSThreadToReplaceENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(16, 10),  // "runReplace"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 4),  // "QDir"
        QT_MOC_LITERAL(33, 4),  // "rDir"
        QT_MOC_LITERAL(38, 8),  // "SysElem*"
        QT_MOC_LITERAL(47, 4),  // "file"
        QT_MOC_LITERAL(52, 3),  // "dir"
        QT_MOC_LITERAL(56, 8),  // "filePath"
        QT_MOC_LITERAL(65, 7)   // "dirPath"
    },
    "ThreadToReplace",
    "runReplace",
    "",
...
void ThreadToReplace::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->runReplace((*reinterpret_cast< std::add_pointer_t<QDir>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<SysElem*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<SysElem*>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[5]))); break;
        default: ;
        }
    }
}
