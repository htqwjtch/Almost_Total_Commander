...
Q_CONSTINIT static const qt_meta_stringdata_CLASSThreadToRemoveENDCLASS_t qt_meta_stringdata_CLASSThreadToRemoveENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(15, 14),  // "removeFinished"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 9),  // "runRemove"
        QT_MOC_LITERAL(41, 8),  // "SysElem*"
        QT_MOC_LITERAL(50, 4),  // "file"
        QT_MOC_LITERAL(55, 3),  // "dir"
        QT_MOC_LITERAL(59, 8),  // "filePath"
        QT_MOC_LITERAL(68, 7)   // "dirPath"
    },
    "ThreadToRemove",
    "removeFinished",
    "",
...
void ThreadToRemove::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->removeFinished(); break;
        case 1: _t->runRemove((*reinterpret_cast< std::add_pointer_t<SysElem*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<SysElem*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[4]))); break;
        default: ;
        }
