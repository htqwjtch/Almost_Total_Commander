...
LinkedPathWindow::LinkedPathWindow(QWidget* parent) : QDialog(parent), ui(new Ui::LinkedPathWindow)
{
    ui->setupUi(this);
...
void LinkedPathWindow::on_path_textEdited(const QString& arg1) { path = arg1; }
