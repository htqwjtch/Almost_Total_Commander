...
#include "../../kypck/File/renamewindow.h"
...
struct qt_meta_stringdata_CLASSRenameWindowENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSRenameWindowENDCLASS = QtMocHelpers::stringData(
    "RenameWindow",
    "on_btnOK_clicked",
    "",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSRenameWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSRenameWindowENDCLASS_t qt_meta_stringdata_CLASSRenameWindowENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSRenameWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject RenameWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSRenameWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSRenameWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRenameWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *RenameWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSRenameWindowENDCLASS.stringdata0))
