...
private:
    ...
    System *folder=&d;  //указатель на объект класса System для получения адреса объекта класса Folder
...
bool RecursiveDelete(QDir&, System *f, System *d);  //функция рекурсивного удаления содержимого выбранной папки
