...
public slots:
    void runRemove(SysElem* file, SysElem* dir, QString dirPath);

public:
    explicit ThreadToRemove(QObject* parent = nullptr);
    bool recursiveDelete(QDir&, SysElem*, SysElem*); //функция рекурсивного удаления содержимого выбранной папки
