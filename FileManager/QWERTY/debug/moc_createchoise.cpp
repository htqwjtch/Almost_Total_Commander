...
namespace {
struct qt_meta_stringdata_CreateChoise_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CreateChoise_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CreateChoise_t qt_meta_stringdata_CreateChoise = {
    {
        QT_MOC_LITERAL(0, 12),  // "CreateChoise"
        QT_MOC_LITERAL(13, 18),  // "on_btnFile_clicked"
        QT_MOC_LITERAL(32, 0),  // ""
        QT_MOC_LITERAL(33, 20),  // "on_btnFolder_clicked"
        QT_MOC_LITERAL(54, 20)   // "on_btnCancel_clicked"
    },
    "CreateChoise",
    "on_btnFile_clicked",
    "",
    "on_btnFolder_clicked",
    "on_btnCancel_clicked"
};
#undef QT_MOC_LITERAL
} // unnamed namespace

Q_CONSTINIT static const uint qt_meta_data_CreateChoise[] = {
...
Q_CONSTINIT const QMetaObject CreateChoise::staticMetaObject = { {
    ...
    qt_meta_stringdata_CreateChoise.offsetsAndSizes,
    qt_meta_data_CreateChoise,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CreateChoise_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CreateChoise, std::true_type>,
        // method 'on_btnFile_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnFolder_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void CreateChoise::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_btnFolder_clicked(); break;
...
void *CreateChoise::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CreateChoise.stringdata0))
